      ...
      <div className="workspace">
        ...
        <main id="content">
          ...
          {page === "device" && <div className="device-page">
            ...
            <RoutingPanel ready={snapshot?.bleReady ?? false} usbSupported={snapshot?.platform === "windows"} usbPresent={snapshot?.usb?.present} generation={snapshot?.ble?.generation ?? 0} />
          </div>}
