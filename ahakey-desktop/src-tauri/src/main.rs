...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            device_routing::get_device_pairing,
            device_routing::select_configuration_transport,
            device_routing::get_device_policy,
            device_routing::reset_device_pairing,
            device_routing::get_device_hosts,
            device_routing::get_host_aliases,
            device_routing::set_host_aliases,
            device_routing::report_this_host,
            device_routing::manage_device_pairing,
            quota::get_cards,
            quota::save_cards,
